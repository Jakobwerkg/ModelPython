...
# Output control
# -------------------------------------------------
out_fname = "output_humidity_test"  # file name of output
...
dt = 10 # time step [s]
diff = 0.1  # (horizontal) diffusion coefficient
...
bv00 = 0.02  # Brunt-Vaisalla frequency [1/s]
...
k_sht = 15  # top level of wind shear layer (ishear = 1)
# top level of wind layer is nz-1 (index)
u00_sh = 5.0  # initial velocity below shear layer [m/s] (ishear = 1)
...
# -------------------------------------------------
vt_mult = 1  # multiplication factor for terminal fall velocity done: 1.0
